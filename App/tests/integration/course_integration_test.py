...
from App.controllers.course import create_course, delete_course, edit_course, get_courses
...
class CourseIntegrationTests(unittest.TestCase):
    ...
    def test_create_course(self) -> None:
        ...
        self.assertEqual(course.course_title, "Intro to computer programming II", "Course title mismatch")
    ...
    def test_edit_course(self) -> None:
        ...
        edit_course(self.course_code, self.semester_id, "Intro to Computer Programming", self.level)
        course: Course = Course.query.get(self.course_code)
        self.assertIsNotNone(course)
    ...
    def test_delete_course(self) -> None:
        ...
        self.assertTrue(delete_course(self.course_code), "Course COMP1601 should be deleted")
        self.assertIsNone(Course.query.get(self.course_code), "Course COMP1601 should not exist after deletion")
