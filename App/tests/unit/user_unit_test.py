...
class UserUnitTests(unittest.TestCase):
    ...
    def test_password_hash(self) -> None:
        ...
        self.assertNotEqual(
            new_user.password, "userpass", "Password should not be stored in plaintext"
        )
    ...
    def test_user_to_json(self) -> None:
        ...
        self.assertEqual(
            user_json, expected_json, "User JSON does not match expected fields or values"
        )
    ...
    def test_new_staff(self) -> None:
        new_staff = Staff(
            11111111, "jane@mail.com", "password", "Jane", "Doe", "Part-Time Tutor"
        )
        ...
        self.assertEqual(
            new_staff.position, Position.PTTUTOR.value, "Staff Position Mismatch"
        )
