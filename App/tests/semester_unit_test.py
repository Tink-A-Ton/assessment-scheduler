...
class SemesterUnitTests(unittest.TestCase):
    def test_new_semester(self) -> None:
        new_semester = Semester(start_date="2024-01-01", end_date="2024-06-30", semester_number=1, max_exams=10)
    ...
    def test_semester_to_json(self) -> None:
        new_semester:Semester = Semester(start_date="2024-01-01", end_date="2024-06-30", semester_number=1, max_exams=10)
